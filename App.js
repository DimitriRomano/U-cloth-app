...
import Product2 from "./src/screens/Product2";
import Carde from "./src/screens/Cate";
import { Home, Summary } from "./src/components";
    ...
    return (
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen name="Carde" component={Carde} />
          ...
          <Stack.Screen name="Filtrer" component={Filter} />
