          ...
          {SIZE.map((item, index) => (
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 50,
                backgroundColor:
                  productSize == index ? COLORS.lightBlue : COLORS.transparent,
              }}
          ...
          >
            <View
              style={{
                ...
                borderWidth: 4,
                borderColor:
                  productColor == index ? COLORS.lightBlue : COLORS.transparent,
              }}
            />
          </TouchableOpacity>
        ))}
        ...
        {TAGS.map((item, index) => (
          <TouchableOpacity
            style={{
              ...
              borderWidth: 1,
              backgroundColor:
                productTag == index ? COLORS.lightBlue : COLORS.transparent,
            }}
            key={item.id}
