...
const PROMOCODES = [
  {
    ...
    discount: "50% ",
    color: "#F4303C",
    term: "Valide jusqu'à 05 juin 2022",
      ...
      >
        ...
        >
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                category == "current" ? COLORS.black : COLORS.lightBlue,
              borderRadius: 30,
              marginHorizontal: 4,
            }}
          >
            <Text
              style={{
                ...
                fontSize: 14,
                color: category == "current" ? COLORS.white : COLORS.black,
              }}
            >
              Courant
            </Text>
          ...
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                category == "used" ? COLORS.black : COLORS.lightBlue,
              borderRadius: 30,
              marginHorizontal: 4,
            }}
          >
            <Text
              style={{
                ...
                fontFamily: "Mulish_600SemiBold",
                fontSize: 14,
                color: category == "used" ? COLORS.white : COLORS.black,
              }}
            >
              Utiliser
            </Text>
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Vous n'avez pas encore de codes promotionnels!
          </Text>
          <Text
            style={{
              textAlign: "center",
