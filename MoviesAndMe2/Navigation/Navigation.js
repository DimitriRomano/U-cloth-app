...
const Tab = createBottomTabNavigator();
    ...
    function SearchStackNavigator() {
        return(
            <Stack.Navigator>
                <Stack.Screen name="Searchs" component={Search} options={{title: 'Rechercher'}} />
    ...
    function FavoriteStackNavigator() {
        return(
            <Stack.Navigator>
                <Stack.Screen name="Favorite" component={Favorites} options={{title: 'Favoris'}} />
                <Stack.Screen name="FilmDetail" component={FilmDetail} />
            </Stack.Navigator>
        );
    }
            ...
            <NavigationContainer>
                <Tab.Navigator screenOptions={
                        ...
                        <Tab.Screen 
                            ...
                            options={{ // On définit le rendu de nos icônes par les images récemment ajoutés au projet
                                headerShown: false,
                                tabBarIcon: ()=>{
                                    return <Image
